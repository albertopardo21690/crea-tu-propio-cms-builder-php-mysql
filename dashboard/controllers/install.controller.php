...
class InstallController {
    ...
    public static function install() {
        if(isset($_POST["email_admin"])) {
            ...
            echo '<script>
                fncMatPreloader("on");
                fncSweetAlert("loading", "Instalando el sistema", "");
            </script>';
            ...
            $sqlModules = "CREATE TABLE modules (
                ...
                id_page_module INT NOT NULL DEFAULT '0',
                ...
                width_module INT NOT NULL DEFAULT '100',
                editable_module INT NOT NULL DEFAULT '1',
            ...
            $sqlColumns = "CREATE TABLE columns (
                ...
                id_module_column INT NOT NULL DEFAULT '0',
                ...
                content_column TEXT NULL DEFAULT NULL,
                visible_column INT NOT NULL DEFAULT '1',
            ...
            if($stmtAdmins->execute() && 
               ...
               $stmtColumns->execute()
                ...
                // Creamos la pagina de administradores
                ...
                // Creamos el modulo Breadcrumb para la página de administradores
                ...
                // Creamos el modulo Tabla para la página de administradores
                   ...
                   $tableModule->status == 200
                    ...
                    if ($countColumns == count($columns)) {
                        echo '<script>
                            fncMatPreloader("off");
                            fncFormatInputs();
                            fncSweetAlert("success","La instalación se realizó correctamente.", setTimeout(() => location.reload(), 1250));
                        </script>';
                    }
                }
            }

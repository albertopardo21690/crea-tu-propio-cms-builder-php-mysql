<div class="container-fluid backgroundImage" <?php if(!empty($admin->back_admin)): ?> style="background-image: url(<?php echo $admin->back_admin; ?>)" <?php else: ?> style="background-color: #f0f0f5 !important;" <?php endif; ?>>
        ...
        <div class="card border-0 rounded shadow p-4 w-25" style="min-width: 320px !important">
            <form method="post" class="needs-validation" novalidate>
                ...
                <div class="form-group mb-3">
                    <label class="mb-2" for="email_admin">Correo</label>
                    <input type="email" class="form-control rounded" id="email_admin" name="email_admin" placeholder="Escriba el correo" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control rounded-start" id="password_admin" name="password_admin" placeholder="Escriba la contraseña"
                        required>
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="">Recordar la sesión</label>
                </div>

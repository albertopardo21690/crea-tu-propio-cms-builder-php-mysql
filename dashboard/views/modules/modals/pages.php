      ...
      <form method="POST" class="needs-validation" novalidate>
        ...
        <div class="modal-body px-4">
            ...
            <div class="form-group mb-3">
                <label class="mb-2" for="title_page">Titulo <sup>*</sup></label>
                <input type="text" class="form-control rounded" id="title_page" name="title_page" required>
            ...
            <div class="form-group mb-3">
                <label class="mb-2" for="url_page">URL <sup>*</sup></label>
                <input type="text" class="form-control rounded" id="url_page" name="url_page" required>
            ...
            <div class="form-group mb-3">
                <label class="mb-2" for="icon_page">Icono <sup>*</sup></label>
                <input type="text" class="form-control rounded cleanIcon" id="icon_page" name="icon_page" required>
            ...
            <div class="form-group mb-3">
                <label class="mb-2" for="type_page">Tipo <sup>*</sup></label>
                <select class="form-select form-select-sm rounded" name="type_page" id="type_page">
